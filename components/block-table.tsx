                ...
                <TableRow key={block.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      <IconButton icon={Edit} label="Bearbeiten" asChild href={`/bloecke/${block.id}/bearbeiten`} />
                      <IconButton icon={Copy} label="Kopieren" onClick={() => handleCopyBlock(block.id)} />
                      <IconButton
                        icon={Trash}
                        label="Löschen"
        ...
        <AlertDialog open={!!blockToDelete} onOpenChange={(open) => !open && setBlockToDelete(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Sind Sie sicher, dass Sie diesen Block löschen möchten? Diese Aktion kann nicht rückgängig gemacht
                werden.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
