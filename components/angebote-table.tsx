                ...
                <TableCell className="text-right">
                  <div className="flex justify-end gap-2">
                    <Button variant="ghost" size="icon" asChild>
                      <Link href={`/angebote/${angebot.originalId}`}>
                        <Edit className="h-4 w-4" />
                        <span className="sr-only">Bearbeiten</span>
                      </Link>
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => handleCopyAngebot(angebot.id)}>
                      <Copy className="h-4 w-4" />
                      <span className="sr-only">Kopieren</span>
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => handlePreview(angebot.id)}>
