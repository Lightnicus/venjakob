                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      <IconButton icon={Edit} label="Bearbeiten" asChild href={`/artikel/${item.id}/bearbeiten`} />
                      <IconButton icon={Copy} label="Kopieren" onClick={() => handleCopyArtikel(item.id)} />
                      <IconButton icon={Trash} label="Löschen" onClick={() => handleDeleteArtikel(item.id)} />
                    </div>
                  </TableCell>
                </TableRow>
              ))}
